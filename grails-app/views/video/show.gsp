	...
	<body>
		...
		<div id="show-video" class="content scaffold-show" role="main">
			...
			<ol class="property-list video">
				...
				<li class="fieldcontain">
					<span id="language-label" class="property-label"><g:message code="video.language.label" default="Language" /></span>
					
						<span class="property-value" aria-labelledby="language-label"><g:fieldValue bean="${videoInstance}" field="language"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${videoInstance?.postDate}">
				<li class="fieldcontain">
				...
				<g:if test="${videoInstance?.urlLink}">
				<li class="fieldcontain">
					<span id="urlLink-label" class="property-label"><g:message code="video.urlLink.label" default="Url Link" /></span>
					
						<span class="property-value" aria-labelledby="urlLink-label"><g:fieldValue bean="${videoInstance}" field="urlLink"/></span>
