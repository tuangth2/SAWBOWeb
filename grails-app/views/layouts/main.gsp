...
<body>
    <div id="SAWBOLogo" role="banner"><a class="home" href="${createLink(uri: '/')}"><img style="width: 200px" src="${resource(dir: 'images', file: 'photo.png')}" alt="SAWBO"/></a></div>
            <g:layoutBody/>
    <div class="footer" role="contentinfo"><img src="images/DotMobile.png" width="50px;"><span style="vertical-align:middle"> Copyright info and general contact information will go here.</span></div>
