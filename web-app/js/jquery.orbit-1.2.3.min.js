...
(function(d) {
    d.fn.orbit = function(a) {
        a = d.extend({animation: "horizontal-push", animationSpeed: 600, timer: !0, advanceSpeed: 4E3, pauseOnHover: !1, startClockOnMouseOut: !1, startClockOnMouseOutAfter: 1E3, directionalNav: !0, captions: !0, captionAnimation: "fade", captionAnimationSpeed: 600, bullets: !1, bulletThumbs: !1, bulletThumbLocation: "", afterSlideChange: function() {
            }}, a);
        return this.each(function() {
            function q() {
                if (!a.timer || a.timer === "false")
                    ...
                    r.is(":hidden") ? s = setInterval(function() {
                        l("next");
                    }, a.advanceSpeed) :
            ...
            function n() {
                if (!a.timer || a.timer === "false")
                    ...
                    o = !1, clearInterval(s), x.addClass("active");
            }
            function z() {
                if (!a.captions || a.captions === "false")
                    return!1;
                else {
            ...
            function A() {
                if (a.bullets)
                    C.children("li").removeClass("active").eq(b).addClass("active");
                else
                    return!1;
            }
            function l(c) {
            ...
            if (e.length === 1)
                a.directionalNav = !1, a.timer = !1, a.bullets = !1;
            ...
            if (a.timer) {
                ...
                if (r.length !== 0) {
                    var t = d("div.timer span.rotator"), y = d("div.timer span.mask"), x = d("div.timer span.pause"), m = 0, s;
                    q();
                    r.click(function() {
                        o ? n() : q();
                    });
            ...
            if (a.bullets) {
                ...
                for (i = 0; i < p; i++) {
                    k = d("<li>" + (i + 1) + "</li>");
                    if (a.bulletThumbs && (w === e.eq(i).data("thumb")))
                        k = d('<li class="has-thumb">' +
